...
|---|---|---|---:|
| NW | Network & Connectivity | `patterns/nw/` | 4 |
...
## Source-aligned additions

- `NW-004 — CCTV IP Video Surveillance Network` is aligned to the supplied McCain GTS SOE & Roadmap for CCTV Closed Circuit and IP Video Surveillance Solutions v1.1, including the supported Model 1, Model 2, Model 3A, and Model 3B deployment options, local-storage requirement, dedicated VLAN/firewall requirement for corporate access, and local vendor maintenance requirement.
